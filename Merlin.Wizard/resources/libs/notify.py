...
def firstRun(msg='', TxtColor='0xFFFFFFFF', Font='font12', BorderWidth=10):
	class MyWindow(xbmcgui.WindowDialog):
		...
		def __init__(self,L=0,T=0,W=1280,H=720,TxtColor='0xFFFFFFFF',Font='font12',BorderWidth=10):
			...
			self.title.setText(title)
			#welcome message
			msg   = "Welcome To Merlin Wizard.\n\nSelect To Launch Wizard Or Dismiss To Never See This Welcome Screen Again!.\n\nThank You For Choosing %s." % (ADDONTITLE)
			msg   = THEME2 % msg
...
#			self.buttonSAVEMENU=xbmcgui.ControlButton(save,t,w1,h1,"          ",textColor="0xFF000000",focusedColor="0xFF000000",alignment=2,focusTexture=focus,noFocusTexture=nofocus)
			self.buttonBUILDMENU=xbmcgui.ControlButton(buildmenu,t,w1,h1,"Launch Wizard",textColor="0xFFFFFFFF",focusedColor="0xFFFFFFFF",alignment=2,focusTexture=focus,noFocusTexture=nofocus)
			self.buttonIGNORE=xbmcgui.ControlButton(ignore,t,w1,h1,"Dismiss",textColor="0xFFFFFFFF",focusedColor="0xFFFFFFFF",alignment=2,focusTexture=focus,noFocusTexture=nofocus)
			self.addControl(self.buttonBUILDMENU); self.addControl(self.buttonIGNORE)
			self.buttonIGNORE.controlLeft(self.buttonBUILDMENU); self.buttonIGNORE.controlRight(self.buttonBUILDMENU)
			self.buttonBUILDMENU.controlLeft(self.buttonIGNORE); self.buttonBUILDMENU.controlRight(self.buttonIGNORE)
...
def doShowcase():
	addFile('  [COLOR yellow][B]Merlin Jarvis[/B][/COLOR]'       ,'playbuildvid1',      icon=ICONSC1, themeit=THEME1)
	addFile('  [COLOR yellow][B]Sky Q[/B][/COLOR]'       ,'playbuildvid2',      icon=ICONSC2, themeit=THEME1)
	addFile('  [COLOR yellow][B]The Kids[/B][/COLOR]'       ,'playbuildvid3',      icon=ICONSC3, themeit=THEME1)
	setView('files', 'THUMB')
